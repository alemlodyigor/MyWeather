...
class forecastData extends View{
    ...
    _generateWeather(){
        ...
        <h3 class="more-container__important__h3">${this._displayDate(this._date.forecast.forecastday[0].date_epoch)}'s forecast</h3>
        <div class="more-container__important__data">
            ...
            <span class="span span__important__data">Feels like</span>
            ...
            <div class="more-container__important__data__details">
                ...
                <p class="more-container__important__data__details__p1">Cloud</p>
            ...
            <div class="more-container__important__data__details">
                ...
                <p class="more-container__important__data__details__p1">Visibility</p>
            ...
            <div class="more-container__important__data__details">
                ...
                <p class="more-container__important__data__details__p1">Humidity</p>
            ...
            <div class="more-container__important__data__details">
                ...
                <p class="more-container__important__data__details__p1">Moon phase</p>
